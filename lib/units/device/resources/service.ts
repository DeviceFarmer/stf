...
import protobuf from '../../../wire/protobuf.js'
...
export default syrup.serial()
  .dependency(adbSyrup)
  .dependency(sdkSyrup)
  .define(function(options: DeviceOptions, adb: Adb, sdk: Sdk): Promise<StfService> {
    ...
    , wire: (protobuf.build(builder) as unknown as StfServiceProtoRoot).jp.co.cyberagent.stf.proto
    , builder: builder
    , startIntent: {
    ...
    function grantPermission(permission: string, minSdk?: number) {
