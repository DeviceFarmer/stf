...
interface PointerTranslatorEvents {
  touchdown: (event: TouchContact) => void
  touchmove: (event: TouchContact) => void
  touchup: (event: {contact: number}) => void
  touchcommit: () => void
}

class PointerTranslator extends EventEmitter.EventEmitter<PointerTranslatorEvents> {
  declare previousEvent: PointerEvent | null
