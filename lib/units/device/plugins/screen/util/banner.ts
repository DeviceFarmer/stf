...
type BannerStream = Duplex & {banner?: MinicapBanner}

var read = function parseBanner(out: BannerStream) {
  var tryRead: () => void

  return new Promise<MinicapBanner>(function(resolve, reject) {
    var readBannerBytes = 0
    var needBannerBytes = 2

    var banner: MinicapBanner = out.banner = {
      version: 0
    , length: 0
    , pid: 0
    , realWidth: 0
