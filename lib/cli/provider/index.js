...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('cleanup-folders', {
      describe: 'Whether to remove /data/local/tmp, /sdcarc or /bugreports folder during cleanup.'
    , type: 'array'
    , default: []
    })
    .option('connect-push', {
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports) {
      ...
      .concat(argv.cleanupFolders ? ['--cleanup-folders', argv.cleanupFolders.join(',')] : [])
