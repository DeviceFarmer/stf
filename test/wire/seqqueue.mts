...
import SeqQueue from '../../lib/wire/seqqueue.js'

type RestartableQueue = SeqQueue & {stop(seq: number): void}
...
describe('SeqQueue', function() {
  ...
  it('should should start a new queue', function() {
    ...
    var spy3 = sinon.spy()
    var spy4 = sinon.spy()
    var q: RestartableQueue = new SeqQueue(10, Infinity)
    q.start(0)
    q.push(1, spy1)
    q.push(2, spy2)
    q.stop(3)
  ...
  it('should should start a new queue on even on 1 length', function() {
    ...
    var spy2 = sinon.spy()
    var spy3 = sinon.spy()
    var q: RestartableQueue = new SeqQueue(2, Infinity)
    q.start(0)
    q.push(1, spy1)
    q.stop(2)
    q.start(0)
