...
import apiutil from '../../lib/util/apiutil.js'
import wire from '../../lib/wire/index.js'
import metrics from '../../lib/util/metrics.js'

function device(properties?: object): Parameters<typeof metrics.deviceState>[0] {
